...
runuser -l azureuser -c '/home/azureuser/myagent/config.sh --unattended  --url https://dev.azure.com/aonkarappa --auth pat --token iusnoqigdhhlmm6ny7wiiw3w3ubakfn5e6l3ykrqrk27ndzosxqq --pool ajith_pool'
